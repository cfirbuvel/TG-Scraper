...
#
#     @property
#     def group_join_interval(self):
#         return self.config.getint(self.section, 'group_join_interval', fallback=60)
#
#     @group_join_interval.setter
#     def group_join_interval(self, val):
#         self.save_val('group_join_interval', str(val))
#
#     @property
...
#                 'Join delay: <code>{}</code> seconds').format(self.last_seen_filter or 'Any', self.group_join_interval)
#
